...
UCLASS()
class PROJECTER_API ABaseCharacter : public ACharacter,
...
protected:
  // 팀 변수
  UPROPERTY(ReplicatedUsing = OnRep_TeamID, EditAnywhere, BlueprintReadWrite,
            Category = "Team")
  ETeamType TeamID;
...
public:
  UPROPERTY(ReplicatedUsing = OnRep_HeroData, EditAnywhere, BlueprintReadWrite,
            Category = "Data", meta = (ExposeOnSpawn = true))
...
public:
  ...
  // UFUNCTION(BlueprintCallable, Category = "Combat|AttackSpeed")
  // float GetCurrentAttackSectionDuration(UAnimMontage* Montage, FName
  // SectionName) const;
...
protected:
  // 현재 타겟 (적)
  UPROPERTY(ReplicatedUsing = OnRep_TargetActor, VisibleAnywhere,
...
#pragma region Vision
  ...
  UFUNCTION(BlueprintPure, BlueprintCallable,
            Category = "Vision") // Helper for getting the vision channel from
                                 // the PlayerStateComp
